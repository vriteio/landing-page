...
const features = [
  {
    ...
    content: (
      <>
        Edit, comment, collaborate - Vrite provides everything you need for
        great team work.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        Publish and manage your content the way you like thanks to full API
        interface and number of integrations.
      </>
    ),
  },
];
      ...
      <div class="flex flex-col md:flex-row gap-12 pb-4 max-w-[40rem]">
        <div class="flex-1">
          ...
          <p class="text-xl md:text-2xl">
            Whether you're working solo, in a small team, or a large
            organization, Vrite scales in all aspects of content production -
