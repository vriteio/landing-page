...
const features = [
  {
    ...
    content: (
      <>
        Write and format your content just the way you prefer it. Use Markdown
        or keyboard shortcut along with modern editing toolbars and menus to
        create your next amazing content piece.
      </>
    ),
  },
  null,
  {
    ...
    content: (
      <>
        The power of VS Code in your code snippet editor. Enjoy code editing
        with advanced syntax highlighting, autocompletion, and more, right
        beside your content. And when you're done, format your code with
        Prettier to manage those tabs and spaces!
      </>
    ),
  },
];
      ...
      <div class="flex flex-col lg:flex-row gap-12 pb-4">
        ...
        <div class="flex-1">
          ...
          <p class="text-xl md:text-2xl">
            Writing experience as developers like it - with everything from
            Markdown support to keyboard shortcuts included.
          </p>
        </div>
      </div>
