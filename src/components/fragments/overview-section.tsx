...
const OverviewSection = () => {
  ...
  const [sliderInstanceRef, setSliderInstanceRef] =
    createSignal<KeenSliderInstance | null>(null);
  ...
  return (
    <Section title="All-in-one technical content toolkit">
      <p class="text-lg max-w-[40rem] mb-4">
        From writing to publishing, Vrite empowers you to work with any kind of
        technical content, while enjoying top User and Developer Experience.
      </p>
      <div class="relative flex-col lg:flex-col-reverse xl:flex-row flex items-center lg:gap-4">
              ...
              return (
                ...
                >
                  <Card
                    ...
                    color={
                      index() === activeSlideIndex() ? "primary" : "contrast"
                    }
        ...
        <div
          class="flex-[2] relative transform keen-slider"
          ref={setContainerRef}
        >
          <For each={slides}>
            {(slide, index) => {
              return (
                ...
                >
                  ...
                  />
                  <Card
                    class="w-full p-4 overflow-hidden m-0 rounded-t-0 lg:hidden"
                    color="soft"
                  >
                    <h2 class="text-xl text-gray-700 dark:text-gray-100">
                      {slide.header}
                    </h2>
