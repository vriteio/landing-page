...
const features = [
  {
    ...
    content: (
      <>
        Manage all the content, easily with workspaces and Kanban dashboard.
        Model your content production stages and publish with a simple drag and
        drop.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        Writers, deadlines, tags - you name it! Add and customize all the
        metadata for every single piece of content. Manage content easier and
        publish faster with all the data in one place.
      </>
    ),
  },
];
                      ...
                      <For each={secondaryFeatures}>
                        {(secondaryFeature, index) => {
                          return (
                            <Observed
                              class={clsx(
                                "transform transition-all duration-500 ease-out flex-1"
                              )}
                              style={{
